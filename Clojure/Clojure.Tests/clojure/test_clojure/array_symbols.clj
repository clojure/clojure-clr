...
;; Easiest just to rewrite this whole thing
...
(defn make-array-of-dim [^Type element-type ^long dim]
  (if (<= dim 0)
    element-type
    (make-array-of-dim (.MakeArrayType element-type) (dec dim))))


(deftest test-array-symbols
  (is (= 'System.String/1 (read-string "System.String/1")))
  (is (= 'String/1 (read-string "String/1")))
  (is (= 'int/2 (read-string "int/2")))
  (testing "array symbol resolution"
    (are [str-repr klass] (= (Type/GetType str-repr) klass)
      "System.Boolean[]" (resolve 'boolean/1)
      "System.Byte[]" (resolve 'byte/1)
      "System.Char[]" (resolve 'char/1)
      "System.Int16[]" (resolve 'short/1)
      "System.Single[]" (resolve 'float/1)
      "System.Double[]" (resolve 'double/1)
      "System.Int32[]" (resolve 'int/1)
      "System.Int64[]" (resolve 'long/1)
      "System.Int64[][]" (resolve 'long/2)
      "System.Object[]" (resolve 'Object/1)
      "System.String[]" (resolve 'String/1)
      "System.String[][]" (resolve 'String/2))
    (is (thrown? clojure.lang.TypeNotFoundException (resolve 'ThisIsNotAClassThatCouldBeFound138/2)))
    (is (thrown? clojure.lang.TypeNotFoundException (resolve 'foo.bar.ThisIsNotAClassThatCouldBeFound138/2))))
  (testing "array hints"
    (util/should-not-reflect
     (let [^long/1 a (long-array [1 2 3 4 99 100])]
       (System.Array/BinarySearch a 99))))
  (testing "syntax quote"
    (is (= `byte/1 'byte/1))
    (is (= `byte/9 'byte/9))
  ...
  (testing "resolution"
    ...
    (is (= (resolve 'String/1) (class (make-array String 0))))
    (is (= (resolve 'System.String/1) (class (make-array String 0))))
    (is (= (resolve 'System.Guid/1) (class (make-array System.Guid 0))))
    (is (= (resolve 'String/2)
           (class (into-array (class (make-array String 0)) [(into-array String ["a" "b"])])))))
  (testing "value position"
    (is (= (class (make-array String 0)) String/1))
  ...
  (testing "printing"
    (is (= "long/1" (print-str long/1)))
    (is (= "byte/1" (print-str (class (make-array Byte 0)))))
    (is (= "System.String/2" (print-str String/2)))
    (is (= "[[System.String/2]]" (print-str [[String/2]])))
    (is (= "System.Guid/4" (print-str System.Guid/4)))
    (is (= "System.Object[][][][][][][][][][]" (print-str (make-array-of-dim Object 10))))
    (is (= "System.Object/9" (print-str (make-array-of-dim Object 9)))))
  (testing "error conditions"
    (is (thrown? Exception (read-string "String/1:")))
    (is (thrown? Exception (read-string "String/0")))
    (is (thrown? Exception (read-string "String/42")))

...
(deftest Numbers
  ...
  (is (= Double/PositiveInfinity ##Inf))                    ;;; Double/POSITIVE_INFINITY
  (is (= Double/NegativeInfinity ##-Inf))                   ;;; Double/NEGATIVE_INFINITY
  (is (and (instance? Double ##NaN) (Double/IsNaN ##NaN)))  ;;; .isNaN 
...
(deftest reader-conditionals
  ...
  (testing "nil expressions"
    (is (nil? #?(:default nil)))
    (is (nil? #?(:foo :bar :cljr nil)))
    (is (nil? #?(:cljr nil :foo :bar)))
...
(defn str->lnpr
  [s]
  (-> s (System.IO.StringReader.) (clojure.lang.LineNumberingTextReader.)))               ;;; java.io.StringReader.            ;;; clojure.lang.LineNumberingPushbackReader.

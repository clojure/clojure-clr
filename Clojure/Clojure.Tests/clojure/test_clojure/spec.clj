...
#_(deftest conform-explain
   (let [a (s/and #(> % 5) #(< % 10))
    ...
    (are [spec x conformed ed]
      ...
      drange 3.1 3.1 nil
      drange 3.2 3.2 nil
      drange Double/PositiveInfinity ::s/invalid [ {:path [] :pred '(not (isInfinite %)), :val Double/PositiveInfinity, :via [], :in []}]               ;;; Double/POSITIVE_INFINITY  Double/POSITIVE_INFINITY
      ...
      a nil "System.NullReferenceException" "System.NullReferenceException"          ;;; "java.lang.NullPointerException" "java.lang.NullPointerException"
      a :k "System.InvalidCastException"    "System.InvalidCastException"            ;;; "java.lang.ClassCastException"   "java.lang.ClassCastException"
...
(def core-pred-syms
  (into #{}
        (comp (map first) (filter (fn [s] (.EndsWith (name s) "?"))))            ;;; .endsWith

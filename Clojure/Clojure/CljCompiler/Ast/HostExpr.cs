    ...
    abstract class HostExpr : Expr, MaybePrimitiveExpr
    {
        ...
        public sealed class Parser : IParser
        {
            public Expr Parse(object frm, bool isRecurContext)
            {
                ...
                if (maybeFieldOrProperty)
                {
                    ...
                    if (t != null)
                    {
                        if ((finfo = Reflector.GetField(t, sym.Name, true)) != null)
                            return new StaticFieldExpr(source, spanMap, t, fieldName, finfo);
                        if ((pinfo = Reflector.GetProperty(t, sym.Name, true)) != null)
                            return new StaticPropertyExpr(source, spanMap, t, fieldName, pinfo);
                        if ((minfo = Reflector.GetArityZeroMethod(t, fieldName, true)) != null)
                            return (MethodExpr)(new StaticMethodExpr(source, spanMap, t, fieldName, PersistentVector.EMPTY));
                    }
                    else if (instance != null && instance.HasClrType && instance.ClrType != null)
                    {
                        ...
                        if ((finfo = Reflector.GetField(instanceType, sym.Name, false)) != null)
                            return new InstanceFieldExpr(source, spanMap, instance, fieldName, finfo);
                        if ((pinfo = Reflector.GetProperty(instanceType,sym.Name,false)) != null)
                            return new InstancePropertyExpr(source, spanMap, instance, fieldName, pinfo);
                        if ((minfo = Reflector.GetArityZeroMethod(instanceType, fieldName, false)) != null)
                            return new InstanceMethodExpr(source, spanMap, instance, fieldName, PersistentVector.EMPTY);
                    }
                    else
                    {
                        ...
                        return new InstanceFieldExpr(source, spanMap, instance, fieldName, null); // same as InstancePropertyExpr when last arg is null
                    }
                }
                ...
                return t != null
                    ? (MethodExpr)(new StaticMethodExpr(source, spanMap, t, methodName, args))
                    : (MethodExpr)(new InstanceMethodExpr(source, spanMap, instance, methodName, args));
            }
        }

...
namespace clojure.lang.CljCompiler.Ast
{
    public abstract class HostExpr : Expr, MaybePrimitiveExpr
    {
                ...
                if (isZeroArityCall)
                {
                    ...
                    if (staticType is not null)
                    {
                        ...
                        if (!isPropName && Reflector.GetArityZeroMethod(staticType, memberName, typeArgs, true) != null)
                            return new StaticMethodExpr(source, spanMap, tag, staticType, memberName, typeArgs, [], tailPosition);
                    ...
                    else if (instance != null && instance.HasClrType && instance.ClrType != null)
                    {
                        ...
                        if (!isPropName && Reflector.GetArityZeroMethod(instanceType, memberName, typeArgs, false) != null)
                            return new InstanceMethodExpr(source, spanMap, tag, instance, instanceType, memberName, typeArgs, [], tailPosition);
        ...
        internal static readonly MethodInfo Method_RT_sbyteCast = typeof(RT).GetMethod("sbyteCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_byteCast = typeof(RT).GetMethod("byteCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_shortCast = typeof(RT).GetMethod("shortCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_ushortCast = typeof(RT).GetMethod("ushortCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_intCast = typeof(RT).GetMethod("intCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_uintCast = typeof(RT).GetMethod("uintCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_longCast = typeof(RT).GetMethod("longCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_ulongCast = typeof(RT).GetMethod("ulongCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_floatCast = typeof(RT).GetMethod("floatCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_doubleCast = typeof(RT).GetMethod("doubleCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_charCast = typeof(RT).GetMethod("charCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_decimalCast = typeof(RT).GetMethod("decimalCast", [typeof(object)]);

        internal static readonly MethodInfo Method_RT_uncheckedSbyteCast = typeof(RT).GetMethod("uncheckedSByteCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_uncheckedByteCast = typeof(RT).GetMethod("uncheckedByteCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_uncheckedShortCast = typeof(RT).GetMethod("uncheckedShortCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_uncheckedUshortCast = typeof(RT).GetMethod("uncheckedUShortCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_uncheckedIntCast = typeof(RT).GetMethod("uncheckedIntCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_uncheckedUintCast = typeof(RT).GetMethod("uncheckedUIntCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_uncheckedLongCast = typeof(RT).GetMethod("uncheckedLongCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_uncheckedUlongCast = typeof(RT).GetMethod("uncheckedULongCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_uncheckedFloatCast = typeof(RT).GetMethod("uncheckedFloatCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_uncheckedDoubleCast = typeof(RT).GetMethod("uncheckedDoubleCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_uncheckedCharCast = typeof(RT).GetMethod("uncheckedCharCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_uncheckedDecimalCast = typeof(RT).GetMethod("uncheckedDecimalCast", [typeof(object)]);

        internal static readonly MethodInfo Method_RT_booleanCast = typeof(RT).GetMethod("booleanCast", [typeof(object)]);

        internal static readonly MethodInfo Method_RT_intPtrCast = typeof(RT).GetMethod("intPtrCast", [typeof(object)]);
        internal static readonly MethodInfo Method_RT_uintPtrCast = typeof(RT).GetMethod("uintPtrCast", [typeof(object)]);
        ...
        public static Type MaybeType(object form, bool stringOk)
        {
            ...
            {
                if (sym.Namespace is null) // if ns-qualified, can't be classname
                {
            ...
            if (paramType.IsPrimitive)
            {
                ...
                else
                {
                    ...
                    if (RT.booleanCast(RT.UncheckedMathVar.deref()))
                    {
                        m = typeCode switch
                        {
                            TypeCode.SByte => HostExpr.Method_RT_uncheckedSbyteCast,
                            TypeCode.Byte => HostExpr.Method_RT_uncheckedByteCast,
                            TypeCode.Int16 => HostExpr.Method_RT_uncheckedShortCast,
                            TypeCode.UInt16 => HostExpr.Method_RT_uncheckedUshortCast,
                            TypeCode.Int32 => HostExpr.Method_RT_uncheckedIntCast,
                            TypeCode.UInt32 => HostExpr.Method_RT_uncheckedUintCast,
                            TypeCode.Int64 => HostExpr.Method_RT_uncheckedLongCast,
                            TypeCode.UInt64 => HostExpr.Method_RT_uncheckedUlongCast,
                            TypeCode.Single => HostExpr.Method_RT_uncheckedFloatCast,
                            TypeCode.Double => HostExpr.Method_RT_uncheckedDoubleCast,
                            TypeCode.Char => HostExpr.Method_RT_uncheckedCharCast,
                            TypeCode.Decimal => HostExpr.Method_RT_uncheckedDecimalCast,
                            _ => throw new ArgumentOutOfRangeException(nameof(paramType), paramType, string.Format("Don't know how to handle typeCode {0} for paramType", typeCode)),
                        };
                    }
                    else
                    {
                        m = typeCode switch
                        {
                            TypeCode.SByte => HostExpr.Method_RT_sbyteCast,
                            TypeCode.Byte => HostExpr.Method_RT_byteCast,
                            TypeCode.Int16 => HostExpr.Method_RT_shortCast,
                            TypeCode.UInt16 => HostExpr.Method_RT_ushortCast,
                            TypeCode.Int32 => HostExpr.Method_RT_intCast,
                            TypeCode.UInt32 => HostExpr.Method_RT_uintCast,
                            TypeCode.Int64 => HostExpr.Method_RT_longCast,
                            TypeCode.UInt64 => HostExpr.Method_RT_ulongCast,
                            TypeCode.Single => HostExpr.Method_RT_floatCast,
                            TypeCode.Double => HostExpr.Method_RT_doubleCast,
                            TypeCode.Char => HostExpr.Method_RT_charCast,
                            TypeCode.Decimal => HostExpr.Method_RT_decimalCast,
                            _ => throw new ArgumentOutOfRangeException(nameof(paramType), paramType, string.Format("Don't know how to handle typeCode {0} for paramType", typeCode)),
                        };
                    }
                }

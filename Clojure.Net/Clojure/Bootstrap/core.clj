...
;;; Need to figure out the equivalent of poolExcuturo.invokeAll
;(defn pcalls
...
;  ([f coll]
;   (let [n (inc (. System.Environment ProcessorCount))  ;;; was (.. Runtime getRuntime availableProcessors))
